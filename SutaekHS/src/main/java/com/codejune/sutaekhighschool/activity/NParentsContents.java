...
public class NParentsContents extends ActionBarActivity {
    //ToolBar
    ...
    public void navigationBarStatusBar() {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                NParentsContents.this.getTheme().resolveAttribute(R.attr.colorPrimary, typedValue19, true);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                NParentsContents.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue21, true);
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            if (Build.VERSION.SDK_INT >= 21){
                ...
                NParentsContents.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
            }
        }
    }
